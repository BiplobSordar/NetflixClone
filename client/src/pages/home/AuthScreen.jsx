	...
	return (
		<div className='hero-bg relative'>
			...
			<div className='flex flex-col items-center justify-center text-center py-40 text-white max-w-6xl mx-auto'>
				<h1 className='text-4xl md:text-6xl text-black font-bold mb-4'>Unlimited movies, TV shows, and more</h1>
				<p className='text-lg mb-4 text-black'>Watch anywhere. Cancel anytime.</p>
